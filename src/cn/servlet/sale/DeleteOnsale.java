...
/**
 * Servlet implementation class DeleteOnsale
 */
@WebServlet("/deleteOnsale.action")
public class DeleteOnsale extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql="delete from goodsinfo where openid=? and gid=?";
